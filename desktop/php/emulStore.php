...
<div class="row row-overflow">
	...
	<legend><i class="fas fa-table"></i> {{Mes émulateurs}}</legend>
	<!-- Champ de recherche -->
	...
	<div class="tab-content">
		...
		<form class="form-horizontal">
			...
			<div class="col-lg-6">
			    ...
			    <div class="form-group">
				<label class="col-sm-3 control-label">{{Temps de décollage (sec.)}}</label>
				<div class="col-sm-7">
				    <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="TempsDecollage" placeholder="{{secondes}}"/>
				</div>
			    </div>
			    <div class="form-group">
		...
		<div class="table-responsive">
			...
			<thead>
				...
				<th style="min-width:80px;width:130px">{{Type}}</th>
				...
				?>
				    <th style="min-width:70px">{{Etat}}</thY>
				<?php
				}
				?>
...
<?php include_file('desktop', 'emulStore', 'js', 'emulStore');?>
